# PaToggleChip Component Plan

## Component Overview

- **Component Name**: PaToggleChip
- **Purpose**: Toggle chip component for tag-like selections.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaToggleChip/PaToggleChip.vue`
- **Token File**: `src/tokens/tier3-component/toggle-chip.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/toggle-chip.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-patogglechip-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaToggleChip/PaToggleChip.vue`
- [x] Index file exists: `src/components/PaToggleChip/index.ts`
