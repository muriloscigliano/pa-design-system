# PaSegmentedControl Component Plan

## Component Overview

- **Component Name**: PaSegmentedControl
- **Purpose**: Segmented control component for selecting between options.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaSegmentedControl/PaSegmentedControl.vue`
- **Token File**: `src/tokens/tier3-component/segmented-control.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/segmented-control.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-pasegmentedcontrol-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaSegmentedControl/PaSegmentedControl.vue`
- [x] Index file exists: `src/components/PaSegmentedControl/index.ts`
