# PaDropdown Component Plan

## Component Overview

- **Component Name**: PaDropdown
- **Purpose**: Dropdown menu component with positioning options.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaDropdown/PaDropdown.vue`
- **Token File**: `src/tokens/tier3-component/dropdown.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/dropdown.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-padropdown-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaDropdown/PaDropdown.vue`
- [x] Index file exists: `src/components/PaDropdown/index.ts`
