# PaSlider Component Plan

## Component Overview

- **Component Name**: PaSlider
- **Purpose**: Slider component for selecting numeric values.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaSlider/PaSlider.vue`
- **Token File**: `src/tokens/tier3-component/slider.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/slider.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-paslider-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaSlider/PaSlider.vue`
- [x] Index file exists: `src/components/PaSlider/index.ts`
