# PaCheckbox Component Plan

## Component Overview

- **Component Name**: PaCheckbox
- **Purpose**: Checkbox input component with checked, unchecked, and indeterminate states.
- **Status**: ✅ Existing
- **Related Components**: PaForm, PaFormContainer
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaCheckbox/PaCheckbox.vue`
- **Token File**: `src/tokens/tier3-component/checkbox.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/checkbox.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-checkbox-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaCheckbox/PaCheckbox.vue`
- [x] Index file exists: `src/components/PaCheckbox/index.ts`
...
- [ ] Basic usage example
- [ ] Advanced usage examples (indeterminate state, with label)
...
- [ ] Proper `role` attributes - Should use semantic `<input type="checkbox">`
...
- [x] `aria-checked` for checkable components - Native checkbox handles this
...
- [x] Enter/Space activates interactive elements - Native checkbox behavior
...
- [ ] Semantic HTML elements used (`<input type="checkbox">`)
- [ ] Form labels properly associated - Needs `<label>` element
- [ ] Error messages announced
- [ ] State changes announced - Checked/unchecked/indeterminate
...
- [ ] No information conveyed by color alone - Checked state needs visual indicator
...
- Indeterminate state needs proper ARIA handling
