# PaLoading Component Plan

## Component Overview

- **Component Name**: PaLoading
- **Purpose**: Loading component for indicating progress.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaLoading/PaLoading.vue`
- **Token File**: `src/tokens/tier3-component/loading.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/loading.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-paloading-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaLoading/PaLoading.vue`
- [x] Index file exists: `src/components/PaLoading/index.ts`
