# PaDrawer Component Plan

## Component Overview

- **Component Name**: PaDrawer
- **Purpose**: Drawer component for slide-out panels.
- **Status**: ❌ Missing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaDrawer/PaDrawer.vue`
- **Token File**: `src/tokens/tier3-component/drawer.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/drawer.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-padrawer-[property]-[variant]-[state]`
...
- [ ] Component file exists: `src/components/PaDrawer/PaDrawer.vue`
- [ ] Index file exists: `src/components/PaDrawer/index.ts`
