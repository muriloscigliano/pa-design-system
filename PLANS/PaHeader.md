# PaHeader Component Plan

## Component Overview

- **Component Name**: PaHeader
- **Purpose**: Header component for application navigation and branding.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaHeader/PaHeader.vue`
- **Token File**: `src/tokens/tier3-component/header.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/header.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-paheader-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaHeader/PaHeader.vue`
- [x] Index file exists: `src/components/PaHeader/index.ts`
