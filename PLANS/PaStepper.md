# PaStepper Component Plan

## Component Overview

- **Component Name**: PaStepper
- **Purpose**: Stepper component for multi-step processes.
- **Status**: ❌ Missing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaStepper/PaStepper.vue`
- **Token File**: `src/tokens/tier3-component/stepper.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/stepper.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-pastepper-[property]-[variant]-[state]`
...
- [ ] Component file exists: `src/components/PaStepper/PaStepper.vue`
- [ ] Index file exists: `src/components/PaStepper/index.ts`
