# PaTooltip Component Plan

## Component Overview

- **Component Name**: PaTooltip
- **Purpose**: Tooltip component for contextual information.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaTooltip/PaTooltip.vue`
- **Token File**: `src/tokens/tier3-component/tooltip.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/tooltip.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-patooltip-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaTooltip/PaTooltip.vue`
- [x] Index file exists: `src/components/PaTooltip/index.ts`
