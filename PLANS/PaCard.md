# PaCard Component Plan

## Component Overview

- **Component Name**: PaCard
- **Purpose**: Card component for displaying content in a contained format.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaCard/PaCard.vue`
- **Token File**: `src/tokens/tier3-component/card.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/card.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-pacard-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaCard/PaCard.vue`
- [x] Index file exists: `src/components/PaCard/index.ts`
