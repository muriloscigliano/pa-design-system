# PaRadio Component Plan

## Component Overview

- **Component Name**: PaRadio
- **Purpose**: Radio button component for single selection in forms.
- **Status**: ✅ Existing
- **Related Components**: PaRadioButtonGroup, PaForm, PaFormContainer
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaRadio/PaRadio.vue`
- **Token File**: `src/tokens/tier3-component/radio.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/radio.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-radio-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaRadio/PaRadio.vue`
- [x] Index file exists: `src/components/PaRadio/index.ts`
...
- [ ] Basic usage example
- [ ] Advanced usage examples (with PaRadioButtonGroup)
...
- [ ] Proper `role` attributes - Should use semantic `<input type="radio">`
- [ ] `aria-label` or `aria-labelledby` where needed
- [ ] `aria-describedby` for help text
- [ ] `aria-invalid` for error states
- [ ] `aria-disabled` for disabled states
- [ ] `aria-expanded` for collapsible components - N/A
- [x] `aria-selected` for selectable components - Native radio handles checked state
- [ ] `aria-checked` for checkable components - Native radio handles this
...
- [x] Arrow keys navigate options (if applicable) - Should navigate within radio group
...
- [ ] Semantic HTML elements used (`<input type="radio">`)
- [ ] Form labels properly associated - Needs `<label>` element
- [ ] Error messages announced
- [ ] State changes announced - Selected/unselected state
...
- [ ] No information conveyed by color alone - Selected state needs visual indicator
...
- Radio buttons must be grouped using PaRadioButtonGroup or fieldset
- Label association is critical for accessibility
- Arrow key navigation within group needs verification
