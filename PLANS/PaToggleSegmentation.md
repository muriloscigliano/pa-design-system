# PaToggleSegmentation Component Plan

## Component Overview

- **Component Name**: PaToggleSegmentation
- **Purpose**: Toggle segmentation component for grouped selections.
- **Status**: ✅ Existing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaToggleSegmentation/PaToggleSegmentation.vue`
- **Token File**: N/A - Component missing or no tokens defined

## Token Review & Updates

### Tier 3 Component Tokens (N/A - No token file yet)
...
- [ ] Ensure tokens follow naming convention: `--pa-patogglesegmentation-[property]-[variant]-[state]`
...
- [x] Component file exists: `src/components/PaToggleSegmentation/PaToggleSegmentation.vue`
- [x] Index file exists: `src/components/PaToggleSegmentation/index.ts`
