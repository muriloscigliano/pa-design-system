# PaTextarea Component Plan

## Component Overview

- **Component Name**: PaTextarea
- **Purpose**: Multi-line text input component with resize options.
- **Status**: ❌ Missing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaTextarea/PaTextarea.vue`
- **Token File**: `src/tokens/tier3-component/textarea.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/textarea.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-patextarea-[property]-[variant]-[state]`
...
- [ ] Component file exists: `src/components/PaTextarea/PaTextarea.vue`
- [ ] Index file exists: `src/components/PaTextarea/index.ts`
