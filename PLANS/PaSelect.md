# PaSelect Component Plan

## Component Overview

- **Component Name**: PaSelect
- **Purpose**: Dropdown select component with single and multi-select support.
- **Status**: ❌ Missing
- **Related Components**: See component relationships
- **Storybook Reference**: https://storybook.payadvantage.com.au
- **File Location**: `src/components/PaSelect/PaSelect.vue`
- **Token File**: `src/tokens/tier3-component/select.json`

## Token Review & Updates

### Tier 3 Component Tokens (`src/tokens/tier3-component/select.json`)
...
- [ ] Ensure tokens follow naming convention: `--pa-paselect-[property]-[variant]-[state]`
...
- [ ] Component file exists: `src/components/PaSelect/PaSelect.vue`
- [ ] Index file exists: `src/components/PaSelect/index.ts`
