...
import { PaPageLayout } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('papagelayout')
})

const getStatesCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaPageLayout } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Page layout component for structuring page content.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`papagelayout-states-${activeStatesTab}`)"
        >
          {{ showCode[`papagelayout-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`papagelayout-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`papagelayout-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaPageLayout component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('papagelayout')"
        copy-key="papagelayout-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaPageLayout component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="papagelayout-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
