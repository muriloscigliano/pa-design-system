...
import { PaLoading } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('paloading')
})

const getStatesCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaLoading } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Loading component for indicating progress.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`paloading-states-${activeStatesTab}`)"
        >
          {{ showCode[`paloading-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`paloading-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`paloading-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaLoading component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('paloading')"
        copy-key="paloading-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaLoading component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="paloading-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
