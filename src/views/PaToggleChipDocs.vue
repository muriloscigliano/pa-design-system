...
import { PaToggleChip } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('patogglechip')
})

const getStatesCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaToggleChip } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Toggle chip component for tag-like selections.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`patogglechip-states-${activeStatesTab}`)"
        >
          {{ showCode[`patogglechip-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`patogglechip-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`patogglechip-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaToggleChip component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('patogglechip')"
        copy-key="patogglechip-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaToggleChip component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="patogglechip-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
