...
import { PaHeroIcon } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('paheroicon')
})

const getUsageCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaHeroIcon } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Hero icon component for landing pages.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode('paheroicon-usage')"
        >
          {{ showCode['paheroicon-usage'] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode['paheroicon-usage']" class="code-preview">
          <CodeBlock 
            :code="getUsageCode(activeTab)"
            :copy-key="'paheroicon-usage-code'"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaHeroIcon component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('paheroicon')"
        copy-key="paheroicon-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaHeroIcon component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="paheroicon-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
