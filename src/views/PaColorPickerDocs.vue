...
import { PaColorPicker } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('pacolorpicker')
})

const getUsageCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaColorPicker } from './components'
...
<template>
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode('pacolorpicker-usage')"
        >
          {{ showCode['pacolorpicker-usage'] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode['pacolorpicker-usage']" class="code-preview">
          <CodeBlock 
            :code="getUsageCode(activeTab)"
            :copy-key="'pacolorpicker-usage-code'"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaColorPicker component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('pacolorpicker')"
        copy-key="pacolorpicker-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaColorPicker component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="pacolorpicker-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
