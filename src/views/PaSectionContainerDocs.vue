...
import { PaSectionContainer } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('pasectioncontainer')
})

const getStatesCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaSectionContainer } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Section container component with title and actions.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`pasectioncontainer-states-${activeStatesTab}`)"
        >
          {{ showCode[`pasectioncontainer-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`pasectioncontainer-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`pasectioncontainer-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaSectionContainer component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('pasectioncontainer')"
        copy-key="pasectioncontainer-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaSectionContainer component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="pasectioncontainer-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
