...
import { PaInlineMessage } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('painlinemessage')
})

const getStatesCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaInlineMessage } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Inline message component for feedback and alerts.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`painlinemessage-states-${activeStatesTab}`)"
        >
          {{ showCode[`painlinemessage-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`painlinemessage-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`painlinemessage-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaInlineMessage component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('painlinemessage')"
        copy-key="painlinemessage-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaInlineMessage component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="painlinemessage-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
