...
import { PaDivider } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('padivider')
})

const getUsageCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaDivider } from './components'
...
<template>
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode('padivider-usage')"
        >
          {{ showCode['padivider-usage'] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode['padivider-usage']" class="code-preview">
          <CodeBlock 
            :code="getUsageCode(activeTab)"
            :copy-key="'padivider-usage-code'"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaDivider component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('padivider')"
        copy-key="padivider-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaDivider component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="padivider-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
