...
import { PaToggle } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('patoggle')
})

const getUsageCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaToggle } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Toggle component (wrapper for PaSwitch).
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode('patoggle-usage')"
        >
          {{ showCode['patoggle-usage'] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode['patoggle-usage']" class="code-preview">
          <CodeBlock 
            :code="getUsageCode(activeTab)"
            :copy-key="'patoggle-usage-code'"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaToggle component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('patoggle')"
        copy-key="patoggle-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaToggle component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="patoggle-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
