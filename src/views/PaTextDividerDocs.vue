...
import { PaTextDivider } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('patextdivider')
})

const getUsageCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaTextDivider } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Divider component for text sections.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode('patextdivider-usage')"
        >
          {{ showCode['patextdivider-usage'] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode['patextdivider-usage']" class="code-preview">
          <CodeBlock 
            :code="getUsageCode(activeTab)"
            :copy-key="'patextdivider-usage-code'"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaTextDivider component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('patextdivider')"
        copy-key="patextdivider-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaTextDivider component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="patextdivider-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
