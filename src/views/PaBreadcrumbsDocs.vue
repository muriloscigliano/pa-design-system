...
import { PaBreadcrumbs } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('pabreadcrumbs')
})
...
<template>
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`pabreadcrumbs-states-${activeStatesTab}`)"
        >
          {{ showCode[`pabreadcrumbs-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`pabreadcrumbs-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`pabreadcrumbs-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaBreadcrumbs component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('pabreadcrumbs')"
        copy-key="pabreadcrumbs-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaBreadcrumbs component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="pabreadcrumbs-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
