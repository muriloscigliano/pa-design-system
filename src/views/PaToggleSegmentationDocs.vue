...
import { PaToggleSegmentation } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('patogglesegmentation')
})
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        Toggle segmentation component for grouped selections.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`patogglesegmentation-states-${activeStatesTab}`)"
        >
          {{ showCode[`patogglesegmentation-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`patogglesegmentation-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`patogglesegmentation-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaToggleSegmentation component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('patogglesegmentation')"
        copy-key="patogglesegmentation-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaToggleSegmentation component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="patogglesegmentation-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
