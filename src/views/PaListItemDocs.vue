...
import { PaListItem } from '../components'
...
onMounted(async () => {
  tokenSource.value = await getComponentTokens('palistitem')
})

const getStatesCode = (tab: string): string => {
  const codes: Record<string, string> = {
    'default': `import { PaListItem } from './components'
  ...
  <div class="component-docs">
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        List item component for displaying items in lists.
      </p>
      ...
      <div class="example-preview-container">
        ...
        <button 
          ...
          @click="toggleShowCode(`palistitem-states-${activeStatesTab}`)"
        >
          {{ showCode[`palistitem-states-${activeStatesTab}`] ? 'Hide code' : 'Show code' }}
        </button>
        <div v-if="showCode[`palistitem-states-${activeStatesTab}`]" class="code-preview">
          <CodeBlock 
            :code="getStatesCode(activeStatesTab)"
            :copy-key="`palistitem-states-usage-${activeStatesTab}`"
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        The complete source code for the PaListItem component.
      </p>
      <CodeBlock 
        :code="getComponentSourceCode('palistitem')"
        copy-key="palistitem-component-source"
        :show-line-numbers="true"
        language="vue"
      />
    </div>
    ...
    <div class="documentation-section">
      ...
      <p class="documentation-section-description">
        CSS custom properties (design tokens) used by the PaListItem component.
      </p>
      <CodeBlock 
        :code="tokenSource"
        copy-key="palistitem-token-source"
        :show-line-numbers="true"
        language="css"
      />
    </div>
